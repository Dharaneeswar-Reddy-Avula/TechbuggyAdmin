...
const Dashboard = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      setLoading(true);
      try {
        const cardResponse = await axios.get('https://backteg-38ub.onrender.com/api/dashboard/cards');
        setCardData(cardResponse.data);
        const chartResponse = await axios.get(`https://backteg-38ub.onrender.com/api/dashboard/chart/${timeframe}`);
